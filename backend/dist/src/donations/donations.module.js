...
const donations_resolver_1 = require("./donations.resolver");
...
exports.DonationsModule = DonationsModule = __decorate([
    (0, common_1.Module)({
        providers: [donations_resolver_1.DonationsResolver, donations_service_1.DonationsService, prisma_service_1.PrismaService],
    })
], DonationsModule);
